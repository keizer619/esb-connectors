...
public class CodeplexProjectsTest extends ESBIntegrationTest {
     ...
     */
    @Test(groups = { "wso2.esb" },priority = 4, description = "codeplex {getProjects} integration test with mandatory parameter.")
    public void testGetProjectsWithMandatoryParameter() throws Exception {
        ...
        int headerResponse;
        try {
            headerResponse = ConnectorIntegrationUtil.sendRequestToRetriveHeaders(getProxyServiceURL(methodName), jsonString);
     ...
     */
    @Test(groups = { "wso2.esb" },priority = 5, description = "codeplex {getProjects} integration test with negative case.")
     ...
     */
    @Test(groups = { "wso2.esb" },priority = 6, description = "codeplex {getAuthenticatedUserProjects} integration test.")
     ...
     */
    @Test(groups = { "wso2.esb" },priority = 7, description = "codeplex {getAuthenticatedUserProjects} integration test for negative case.")
