...
public class CodeplexUsersTest extends ESBIntegrationTest {
     ...
     */
    @Test(groups = { "wso2.esb" },priority = 0, description = "codeplex {getUser} integration test with mandatory parameter.")
     ...
     */
    @Test(groups = { "wso2.esb" },priority = 3, description = "codeplex {getAuthenticatedUser} integration test for negative case.")
