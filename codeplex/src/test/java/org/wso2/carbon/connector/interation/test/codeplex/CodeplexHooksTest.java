...
public class CodeplexHooksTest extends ESBIntegrationTest {
    ...
    public void testGetSupportedHooks() throws Exception {
        ...
        String modifiedJsonString = String.format(jsonString, codeplexConnectorProperties.getProperty("clientId"), codeplexConnectorProperties.getProperty("clientSecret"), codeplexConnectorProperties.getProperty("refreshToken"));
     ...
     */
    @Test(groups = { "wso2.esb" },priority = 9, description = "codeplex {getSupportedHooks} integration test for negative case.")
     ...
     */
    @Test(groups = { "wso2.esb" },priority = 10, description = "codeplex {createSubscription} integration test with mandatory parameters.")
    public void testCreateSubscriptionWithMandatoryParameters() throws Exception {
        ...
        modifiedJsonString = String.format(jsonString, codeplexConnectorProperties.getProperty("clientId"), codeplexConnectorProperties.getProperty("clientSecret"), codeplexConnectorProperties.getProperty("refreshToken"), subscriptionId);
        proxyAdmin.addProxyService(new DataHandler(new URL(proxyFilePath)));
     ...
     */
    @Test(groups = { "wso2.esb" },priority = 10, description = "codeplex {createSubscription} integration test with optional parameters.")
     ...
     */
    @Test(groups = { "wso2.esb" },priority = 11, description = "codeplex {createSubscription} integration test with negative test case.")
     ...
     */
    @Test(groups = { "wso2.esb" },priority = 12, description = "codeplex {getSubscription} integration test with mandatory parameters.")
     ...
     */
    @Test(groups = { "wso2.esb" },priority = 13, description = "codeplex {getSubscription} integration test with negative test case.")
     ...
     */
    @Test(groups = { "wso2.esb" },priority = 14, description = "codeplex {getHookSubscriptions} integration test with mandatory parameters.")
     ...
     */
    @Test(groups = { "wso2.esb" },priority = 15, description = "codeplex {getHookSubscriptions} integration test with negative test case.")
     ...
     */
    @Test(groups = { "wso2.esb" },priority = 16, description = "codeplex {DeleteSubscription} integration test with mandatory parameters.")
    public void testDeleteSubscriptionWithMandatoryParameters() throws Exception {
        ...
        try {
            ...
            responseHeader = ConnectorIntegrationUtil.sendRequestToRetriveHeaders(getProxyServiceURL(methodName), modifiedJsonString);
     ...
     */
    @Test(groups = { "wso2.esb" },priority = 17, description = "codeplex {DeleteSubscription} integration test for negative case.")
     ...
     */
    @Test(groups = { "wso2.esb" },priority = 18, description = "codeplex {updateSubscription} integration test with mandatory parameters.")
     ...
     */
    @Test(groups = { "wso2.esb" },priority = 19, description = "codeplex {updateSubscription} integration test with all optional parameters.")
     ...
     */
    @Test(groups = { "wso2.esb" },priority = 20, description = "codeplex {updateSubscription} integration test for negative case.")
     ...
     */
    @Test(groups = { "wso2.esb" },priority = 21, description = "codeplex {updateSubscription} integration test with optional parameter one.")
     ...
     */
    @Test(groups = { "wso2.esb" },priority = 21, description = "codeplex {updateSubscription} integration test with optional parameter two.")
     ...
     */
    @Test(groups = { "wso2.esb" },priority = 22, description = "codeplex {updateSubscription} integration test with optional parameter three.")
